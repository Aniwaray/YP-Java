...
public class Database {
    ...
    public void insertOrder(Integer count, Integer finalPrice, Integer point, Integer product, Integer client, Integer staff) throws SQLException, ClassNotFoundException {
    ...
    public Integer getIdStaff(String log, String pass) throws SQLException, ClassNotFoundException {
        String sql = "SELECT id_staff FROM staff where login = '" + log + "' and password= '" + pass + "'";
        PreparedStatement statement = getDbConnection().prepareStatement(sql);
        ResultSet res = statement.executeQuery();
        int id_staff = 0;
        while (res.next()) {
            id_staff = res.getInt(1);
        }
        return id_staff;
    }
